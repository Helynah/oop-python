...
rooms = {
    ...
    "master bedroom": {
        ...
        "look": "It's cozy in here. Relax and feel comfortable.You can go up \
...
and friends.",
    ...
    "study room": {
        ...
        "look": "The walls of the study room are framed with inspirational \
...
def move(current_location):
    """Function to navigate through the rooms in the hose"""
